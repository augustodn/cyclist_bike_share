...
Rename columns to standardize the dataset. Note that for this case, `usertype` is mixed when comparing 
how the categories are distributed in number of rides and usage hours versus previous quarters.
Hence, labels have been renamed accordingly
...
bike_shares <- bike_shares %>%
  ...
  # categories for 2020 changes, it's believed that they are bad ordered
